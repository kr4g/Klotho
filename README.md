...
4. **Play**:
    ...
    To use`AlloPy` as a scripting tool, the [`AlloPy/examples/`](https://github.com/kr4g/AlloPy/tree/main/examples) directory contains examples of how to use the modules in this manner.
