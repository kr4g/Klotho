...
def example(r_trees: list, hexany: tonos.scales.CPS = tonos.scales.CPS((1, 3, 5, 13), 2), use_hex=False, inv_freq_range=True, init_bpm: float = 66, start_offset: float = 0.0):
    '''
    '''
    tempo = init_bpm
    pan = -1.0
...
def composition(r_trees: list, hexany: tonos.scales.CPS = tonos.scales.CPS((1, 3, 5, 13), 2), equaves: list = [0, 1, 2, 3], dyn_range: list = [aikous.DYNAMICS.pp, aikous.DYNAMICS.mp], init_bpm: float = 60, start_offset: float = 0.0):    
    '''
    '''
    tempo = init_bpm
    rows_list = []
...
def composition_ii(r_trees: list, hexany: tonos.scales.CPS = tonos.scales.CPS((1, 3, 5, 13), 2), equaves: list = [0.125, 0.25, 0.5, 0, 1], dyn_range: list = [aikous.DYNAMICS.ppp, aikous.DYNAMICS.p], init_bpm: float = 60, start_offset: float = 0.0):
    '''
    '''
    tempo = init_bpm
    rows_list = []
...
def compositions():
    ...
    # subdivisions = ((21, (8, (5, (3, 2, (1, (3, 2, 1, (1, (13, 8, 5)))))))))
    ...
    hex                 = tonos.scales.CPS((1, 3, 5, 9, 11), 3)
    hex_i               = tonos.scales.CPS((1, 5, 9), 2)
    # hex_ii              = tonos.scales.CPS((1, 3, 5, 7, 13, 21), 3)
    hex_ii              = tonos.scales.CPS((1, 13, 23, 31, 47, 51, 53), 4)
    max_rotations       = 9
